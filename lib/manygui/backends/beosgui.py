"""
beosgui.py, a part of manygui that allows manygui applications to directly drive BeOS GUI functions.
...
This version of beosgui.py (and the manygui it is part of) are a work in progress.  Please visit manygui.sf.net to see if there is a newer version.
