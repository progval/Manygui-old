...
class WeakReference(Reference):
    def ref(self, obj, cb):
        ...
        return_ = weakref.ref(obj, cb)
        print('Weak ref: ' + repr(return_))
        return return_
    def deref(self, obj):
        print('Weak deref: ' + repr(obj) + ' ' + repr(obj()))
        return obj()

class StrongReference(Reference):
    def ref(self, obj, cb):
        print('Strong ref: ' + repr(obj))
        return obj
    def deref(self, obj):
        print('Strong deref: ' + repr(obj))
        return obj
...
class CallableReference:
    ...
    def __init__(self, func, weak):
        print('Callable1: ' + repr(func))
        obj, func = unwrap(func)
        print('Callable2: ' + repr(obj) + ' ' + repr(func))
    ...
    def __eq__(self,other):
        ...
        print('1: ' + repr(ref_is(self.obj,other.obj)))
        print('2: ' + repr(ref_is(self.func,other.func)))
