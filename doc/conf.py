# -*- coding: utf-8 -*-
#
# Manygui documentation build configuration file, created by
...
project = u'Manygui'
copyright = u'2011, Manygui contributors'
...
latex_documents = [
  ('index', 'Manygui.tex', u'Manygui Documentation',
   u'Manygui contributors', 'manual'),
]
